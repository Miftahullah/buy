                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-md-6 ">
                         <li><a href="https://maps.app.goo.gl/RQfKXvMWFfN3iyAB6" style="color:white"><i class="fa fa-podcast"> Kantor BRIDA NTB Cek Lokasi disini</i></a></li>
                        </div>
                        <div class="col-xl-6 col-md-6">
                            <div class="short_contact_list">
                                <ul>
                                    <li><a href="#"> <i class="fa fa-envelope"></i> bridantb1@gmail.com</a></li>
                                    <li><a href="#"> <i class="fa fa-phone"></i>+62876493987</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="header_bottom_border">
                        <div class="row align-items-center">
                            <div class="col-xl-3 col-lg-2">
                                <div class="logo">
                                    <a href="index.php">
                                        <img src="img/logo brida.png" width="100px">
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text">
                                ...
                                <p>Selamat datang di website Pengaduan Masyarakat BRIDA NTB<br>
...
copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">BRIDA NTB</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
...
<div class="floatwa">
<a href="https://api.whatsapp.com/send?phone=6282245875889&amp;text=Halo%20ADMIN,%20Saya%20mau%20Lapor,saya lupa akun" target="_blank"><div class="tombolwa">LUPA PASSWORD?SILAHKAN LAPOR DISINI!</div></a></div> 
</body>
